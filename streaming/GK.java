...
public class GK {
	...
	public static void greenwald_khanna(int n, double v, ArrayList<Tuple> s, double e) {
	...
	public static ArrayList<Double> quantile(double phi, int n, ArrayList<Tuple> s, double e) {

		ArrayList<Double> quantile = new ArrayList<Double>(1);
	...
	private static void insert(int n, double v, ArrayList<Tuple> s, double e) {
